...
from .views import PasswordUserChangeView
...
urlpatterns = [
    ...
    path('register/done/', views.RegisterUserDone.as_view(), name='register_done'),
    path('profile/', views.ProfileUser.as_view(), name='profile'),
    path('password-change/', PasswordUserChangeView.as_view(), name='password_change'),
